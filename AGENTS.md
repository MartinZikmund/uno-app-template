...
template's own dev tooling (Dev assets, worktree identity, including the About page's worktree label) go in
**`tests/Template.SelfTests`** instead, because apps delete that project (see `.claude/rules/testing.md`).
